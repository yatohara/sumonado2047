...
// funcoes presente
states get_state(double front_sensor, int left_line, int right_line, long rotate_start_time);
...
states get_state(double front_sensor, int left_line, int right_line, long rtime){

    if ((front_sensor <= DIST)){
        return attack;
    }
